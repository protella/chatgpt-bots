...
class BotConfig:
    ...
    # >>> To brand these, set STATUS_LOADING_MESSAGES in .env with REAL acmedata custom-emoji
    # >>> names, e.g.  STATUS_LOADING_MESSAGES=:acmedata: crunching the data…,:acmedata: digging in…
