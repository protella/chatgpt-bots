...
# ("U-vinay"), and the predicate has to recognize its callers' own mentions (codex ack #14).
...
def origin_ack_violation(text: str, *, fragments: Sequence[str] = (),
    ...
    - ADDRESSEES: the caller may name the people in the room, and their names are ADDRESS, the
      same rule as @-mentions (measured in: a real trial wrote "Thanks, Vinay." and the grammar
    ...
    # "Thanks, Vinay." and "Vinay, thanks." strip while a name inside a clause never does:
    # "Thanks for ChatGPT closing the loop." and "Thanks for checking Vinay." both keep the name
    # and die in the grammar. The comma-less "Thanks Vinay." failing too is the strict side.
